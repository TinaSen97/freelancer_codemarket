  ...
  <style type="text/css">
    @import url("https://fonts.googleapis.com/css?family={{ str_replace('+', ' ', $addition_settings->theme_font_family) }}");
  ...
  .widget-list-link:hover, .jplist-selected {
    color: {{ $allsettings->site_button_hover }} !important;
    font-weight: bold;
  }
  .ui-widget-header {
  ...
  .form-control:focus {
    ...
    border-color: {{ $allsettings->site_button_color }} !important;
    outline: 0;
  }
  .bg-primary {
  ...
  button.bg-primary:focus {
    background-color: {{ $allsettings->site_button_hover }} !important;
  }
  ...
  .bg-dark {
    background-color: {{ $allsettings->site_header_color }} !important;
  }
  a.bg-dark:hover,
  a.bg-dark:focus,
  ...
  .btn-outline-accent:hover {
    ...
    border-color: {{ $allsettings->site_theme_color }};
  }
  ...
  .bg-darker {
    background-color: {{ $allsettings->site_footer_color }} !important;
  }
  a {
    color: {{ $allsettings->site_button_color }};
    text-decoration: none;
  ...
  .display-404 {
    color: #fff;
    font-size: 10rem;
    text-shadow: -0.0625rem 0 {{ $allsettings->site_button_color }}, 0 0.0625rem {{ $allsettings->site_button_color }}, 0.0625rem 0 {{ $allsettings->site_button_color }}, 0 -0.0625rem {{ $allsettings->site_button_color }};
  }
  .red {
    width: 100%;
    margin-top: .25rem;
  ...
  /* -------------------------------------------------------------------
    NAVBAR TEXT WEIGHT + HOVER COLOR CHANGES
    ------------------------------------------------------------------- */
  /* Make sure text is NOT too bold (set to 400) */
  .navbar-light .navbar-nav .nav-link {
    font-size: 16px;
    font-weight: 600; /* Normal weight instead of bold */
    color: #010101;
  }

  /* Change hover color to site_header_color instead of site_button_color */
  .navbar-modern .navbar-nav .nav-link:hover,
  .navbar-light .navbar-nav .nav-link:hover {
    color: {{ $allsettings->site_header_color }} !important;
  }

  /* -------------------------------------------------------------------
    ANIMATED DROPDOWNS + SEARCH, ETC.
    ------------------------------------------------------------------- */
  .animated-dropdown {
    opacity: 0;
  ...
  .search-container {
    position: relative;
    width: 40px; /* Initially only shows the round search icon */
    height: 40px;
    overflow: hidden;
  ...
  .search-container .search-input-round {
    position: absolute;
    left: 40px;
    top: 0;
    width: 0;
  ...
  .search-container.active .search-input-round {
    width: calc(100% - 40px);
    opacity: 1;
  }
  .hamburger {
  ...
  /* Main Navbar (white background, black text) */
  .navbar-modern {
    background: #fff;
  ...
  /* We override the hover color for .navbar-modern nav links below:
    (Already done in the block for site_header_color)
  */

  /* Elevated Navbar Icons */
